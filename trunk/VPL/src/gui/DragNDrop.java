...
public class DragNDrop implements DragGestureListener,DragSourceListener, DropTargetListener{
	 ...
	 *
	 * @param sprites		<code>ArrayList<Sprite></code>
	 * @param lines			<code>ArrayList<Sprite></code>
	...
	/**
 	 * Este M&eacutetodo, y los cuatro que le siguen, 
 	 * implementan la interfaz del <code>DragSourceListener</code>. 
 	 * <code>dragDropEnd()</code> es invocado cuando el usuario 
 	 * suelta la figura que estaba tomando.
 	 *
 	 * @param e		<code>DragSourceDragEvent</code>
 	 */ 
	 ...
	 *
	 * @param e		<code>DragTargetDropEvent</code> 
	 */
